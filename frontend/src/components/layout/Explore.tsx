          ...
          <div className="relative">
            ...
            <div className="bg-green-300  p-8 hover:shadow-sm transition-shadow duration-200 relative z-10">
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center">
                Your Daily Dose of GDG Inspiration!
              </h2>
              <p className="text-lg md:text-xl text-gray-700 mb-6 text-center">
                Step into the world of GDG podcasts, a space made for students
                and tech enthusiasts who love learning. Discover new concepts
                and experiences. Small lessons today, big impact tomorrow.
              </p>
            </div>
          </div>
        </div>
